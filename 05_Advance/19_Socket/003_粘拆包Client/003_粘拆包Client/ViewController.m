...
// 两种粘包:
// 1: 发送一段数据 : 数据长度+类型+data  data ....
// 2: "<adskjaskjo;> <asdjgkjgasd>",不好 nil 越界
// 3: 268ua/ 数据长度+类型+data 2698uo/
...
- (IBAction)didClickDisconnectAction:(id)sender {
    NSString *path = [[NSBundle mainBundle] pathForResource:@"q1" ofType:@"mp4"];
